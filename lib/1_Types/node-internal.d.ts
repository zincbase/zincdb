...
/*
Regular Expressions for conversion to internal modules:

find: declare module \"(\w+)\"
replace with: declare module $1
...
declare var Buffer: {
	...
	new (arrayBuffer: ArrayBuffer): Buffer; // Modification
	/**
	 * Allocates a new buffer containing the given {array} of octets.
	 *
	 * @param array The octets to store.
...
declare module https {
	...
	export var Agent: {
		new (options?: http.AgentOptions): Agent;
	};
